...
% this time
function [your_strategy] = id39(counterparty_id)
    counterparty_now = counterparty_id;     
    % as loading the infor_id39.mat will give a variable named
    ...
    Trade_no = Trade_no + 1;
    save storage_id39.mat Trade_no your_id list_betray    
end