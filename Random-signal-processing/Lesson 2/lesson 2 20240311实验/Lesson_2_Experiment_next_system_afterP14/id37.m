...
% this time
function [your_strategy] = id37(counterparty_id)
    counterparty_now = counterparty_id;     
    % as loading the infor_id37.mat will give a variable named
    ...
    Trade_no = Trade_no + 1;
    save storage_id37.mat Trade_no your_id list_betray    
end