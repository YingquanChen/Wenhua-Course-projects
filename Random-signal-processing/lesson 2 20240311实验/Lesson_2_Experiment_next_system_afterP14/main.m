...
Repeated_trails = 1;                        % repeat the game Repeated_trails times
N_trades = 200;                              % trade N_trades times
N_persons = 40;                             % totally N_persons persons
...
for n_re_tr = 1:Repeated_trails
    ...
    % note that they should be created befor every game, therefore, in the
    % beginning of the game, the Trade_no will be 0 for all persons!
    creat_infor(N_persons);                   % create all the infor_idXX.mat, and also, clear the action to 0
